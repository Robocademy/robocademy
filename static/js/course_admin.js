...
$(function() {
    ...
    $('.add_answer_choice').live('click', function() {
        ...
        $(this).parent().find('.answer_choices').append('<li><input name="lesson_'+order+'_answer_{{ x.id }}" type="checkbox" /> <input type="text" name="lesson_'+order+'_answer_choice_" value="" /><input type="button" value="X" /></li>')
    });
